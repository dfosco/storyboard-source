...
export default defineConfig(() => {
    ...
    resolve: {
        ...
        alias: {
            ...
            '@dfosco/storyboard/config': path.resolve(__dirname, 'packages/storyboard/src/core/configSchema.js'),
            '@dfosco/storyboard/modes.css': path.resolve(__dirname, 'packages/storyboard/src/core/modes.css'),
            '@dfosco/storyboard/inspector/highlighter': path.resolve(__dirname, 'packages/storyboard/src/core/inspector/highlighter.js'),
            '@dfosco/storyboard/smooth-corners': path.resolve(__dirname, 'packages/storyboard/src/core/smoothCorners.js'),
