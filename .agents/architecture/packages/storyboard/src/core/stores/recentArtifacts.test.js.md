# `packages/storyboard/src/core/stores/recentArtifacts.test.js`

<!--

source: packages/storyboard/src/core/stores/recentArtifacts.test.js
...
`recentArtifacts.test.js` documents the behavioral guarantees for [`packages/storyboard/src/core/stores/recentArtifacts.js`](recentArtifacts.js.md): MRU ordering, deduplication, size caps, label fallback, and safe clearing.
...
- `beforeEach(clearRecent)` keeps the singleton localStorage state isolated between cases.
