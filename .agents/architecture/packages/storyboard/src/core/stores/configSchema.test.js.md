# `packages/storyboard/src/core/stores/configSchema.test.js`

<!--

source: packages/storyboard/src/core/stores/configSchema.test.js
...
`configSchema.test.js` verifies that [`packages/storyboard/src/core/stores/configSchema.js`](configSchema.js.md) remains backward-compatible as new config domains are added. It asserts default completeness, non-mutating merges, and array-replacement semantics.
...
- [`packages/storyboard/src/core/stores/configSchema.js`](configSchema.js.md) — imported via `./configSchema.js`.
...
- The tests double as executable documentation for paste-rule defaults, command palette defaults, and customer-mode defaults.
