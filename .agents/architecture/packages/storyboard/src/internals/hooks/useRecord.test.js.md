# `packages/storyboard/src/internals/hooks/useRecord.test.js`

<!--
source: packages/storyboard/src/internals/hooks/useRecord.test.js
category: storyboard
importance: high
-->
...
This test file locks down the public behavior of `useRecord`. It documents the supported API in executable form and protects the hook from regressions as the underlying data, hash, storage, and routing layers evolve.
...
- Focus: record lookup, merged collections, scope, and hide mode.
...
- The scenarios here serve as the clearest executable summary of the contract for `packages/storyboard/src/internals/hooks/useRecord.js`.
