# `packages/storyboard/src/internals/hooks/useFlows.test.js`

<!--
source: packages/storyboard/src/internals/hooks/useFlows.test.js
category: storyboard
importance: high
-->
...
This test file locks down the public behavior of `useFlows`. It documents the supported API in executable form and protects the hook from regressions as the underlying data, hash, storage, and routing layers evolve.
...
- Focus: flow discovery and switching contract.
...
- The scenarios here serve as the clearest executable summary of the contract for `packages/storyboard/src/internals/hooks/useFlows.js`.
