# `packages/storyboard/src/internals/hooks/useSession.test.js`

<!--
source: packages/storyboard/src/internals/hooks/useSession.test.js
category: storyboard
importance: high
-->
...
This test file locks down the public behavior of `useSession`. It documents the supported API in executable form and protects the hook from regressions as the underlying data, hash, storage, and routing layers evolve.
...
- Focus: backwards-compatible session alias.
...
- The scenarios here serve as the clearest executable summary of the contract for `packages/storyboard/src/internals/hooks/useSession.js`.
