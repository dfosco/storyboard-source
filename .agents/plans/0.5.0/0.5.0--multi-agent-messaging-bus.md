...
### ✅ Phase 4: Bus-Backed Terminal Messaging (DONE — `0.5.0--messaging-bus` branch)
...
11. **Canvas widget rule** — Already done: agents don't create widgets for message sends (exception to Prime Directive)
